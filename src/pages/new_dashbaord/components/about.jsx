...
export function AboutSection() {
    return (
        <section className="pb-12 ">
            <div className=" text-black p-4 md:p-12 flex flex-col md:max-w-[65%] w-[95%] mx-auto items-center justify-center lg:p-16 ">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center mb-6">
                    About Avenue Impact
                </h2>
                <p style={{ lineHeight: '40px' }} className=" mb-8 tracking-wider text-center md:text-xl">
                ...
                <div>
                    <button
                    size="lg"
                    className="bg-[#14345F] flex items-center hover:bg-white/20 text-white border border-white/20 rounded-full px-12 py-4 gap-4"
                    >
                        Give Feedback 
                    </button>
                </div>
