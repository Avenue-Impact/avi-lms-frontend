  ...
  return (
    <Modal>
      <div className="w-[400px] p-6 bg-white rounded-lg">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Set Expiration Date</h3>
        <p className="text-sm text-gray-500 mb-6">
          Set the exact date when the student's access to this cohort and its recorded sessions will expire.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3">
            ...
            <CommonButton
              type="submit"
              disabled={isPending || !accessExpiresAt}
